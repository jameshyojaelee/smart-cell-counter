  ...
  return `
    ...
    <body>
      ...
      ${!options.removeWatermark ? `
        <div class="watermark">
          Generated by Smart Cell Counter
        </div>
      ` : ''}
    </body>
    </html>
...
export async function generatePDFReport(
  ...
  try {
    const html = generatePDFHTML(sample, squareCounts, qcAlerts, options);
...
export async function generatePDFWithImages(
  ...
  try {
    ...
    const baseHTML = generatePDFHTML(sample, squareCounts, qcAlerts, options);
